...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_bkos0es', // paste your ServiceID here (you'll get one when your service is created).
        'template_htsvhnd', // paste your TemplateID here (you'll find it under email templates).
        {
          from_name: form.name,
          to_name: 'Faiz Raza', // put your name here.
          from_email: form.email,
          to_email: 'faiz.raza.dec@gmail.com', //put your email here.
          message: form.message,
        },
        'U1kX20VbdzL_iYBO3' //paste your Public Key here. You'll get it in your profile section.
      )
      .then(
        () => {
          setLoading(false);
  ...
  return (
<div className="flex flex-col xl:flex-row gap-10 -mt-[5rem] overflow-hidden">
  {/* Left Div */}
  <div className="w-full xl:w-1/2 mr-auto">
    <motion.div
      variants={slideIn('left', 'tween', 0.2, 1)}
      className="flex-[0.75] bg-darkblue p-8 rounded-2xl">
  ...
  <div className="w-full xl:w-1/2 ml-auto">
    <div className="flex justify-center items-center h-full">
      <img
        src='src/assets/backgrounds/con.gif'
        alt="Contact Image"
